package tnsif.com.daytwentytwo;
...
public class StreamClass {
	...
	public static void main(String[] args) {
		...
		/*
		// creating of list from an array of integers
		...
		List<String> nameList=Arrays.asList("aarti","xyz","abc");
		...
		//filter()
		//to filter only odd numbers from intList[4,3,2,7,9]
		intStream=intList.stream();
		Stream<Integer> result=intStream.filter(n->n%2!=0);
		List rList=(List) result.collect(Collectors.toList());
		System.out.println(rList);
		
		//filter()-returns palindrome string
		List<String> words=Arrays.asList("cat","car","racecar","madam");
		System.out.println(words);
